...
1. You will learn how to search efficiently when you have a large space. 
...
## Part 3 - Map acquisition (10 marks)
...
## Part 4 - Localize your robot with Particle Filter (40 marks, 20 code + 20 in-lab)
...
- See through implementing a search algorithm for the map occupancy grids and each particle weight calculation in ```particle.py``` and ```mapUtilities.py```; You will need to explain two functions to a TA in the lab.
...
## Part 5 - Integration to the stack (20 marks, 10 code + 10 in-lab)
