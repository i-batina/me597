...
from geometry_msgs.msg import Twist # For sending velocity commands to the robot
...
class motion_executioner(Node):
    ...
    def imu_callback(self, imu_msg: Imu):
        ...
        self.imu_logger.log_values([imu_msg.linear_acceleration.x, imu_msg.linear_acceleration.y, imu_msg.angular_velocity.z, timestamp])
    ...
    def odom_callback(self, odom_msg: Odometry):
        ...
        self.odom_logger.log_values([position.x, position.y, yaw, timestamp])
        self.odom_initialized=True
        
    def laser_callback(self, laser_msg: LaserScan):
        timestamp = Time.from_msg(laser_msg.header.stamp).nanoseconds
        self.laser_logger.log_values([laser_msg.ranges, laser_msg.angle_increment, timestamp])
    ...
    def make_circular_twist(self):
        ...
        msg=Twist() # fill up the twist msg for circular motion
        msg.linear.x = 0.2
        msg.angular.z = 0.4
        return msg
